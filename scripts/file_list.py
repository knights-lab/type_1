...
for query_file in query_files:
    ...
    rsync_command = f"""mkdir -p ./mock_communities/{group_1}/filter && rsync -rP hillm096@teraminx.cs.umn.edu:{base_query_path}/allpath.r202.b6 ./mock_communities/{group_1}/filter/allpath.r202.b6"""
    print(rsync_command)
