...
for b6_file in b6_files:
    ...
    command_coverage = f"""/usr/bin/time -v /mnt/nvidia/pkr/code/type_1/type_1/main.py features-alignment \
{db_features} \
{b6_file} \
{base_path}/coverage.t1.r202.txt \
> {base_path}/shogun.coverage.t1.r202.log 2>&1"""
