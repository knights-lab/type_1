...
# Average CV score on the training set was: 0.8691759892812945
exported_pipeline = make_pipeline(
    OneHotEncoder(minimum_fraction=0.25, sparse=False, threshold=10),
    VarianceThreshold(threshold=0.1),
    StackingEstimator(estimator=GradientBoostingClassifier(learning_rate=1.0, max_depth=2, max_features=0.7000000000000001, min_samples_leaf=20, min_samples_split=5, n_estimators=100, subsample=0.05)),
    ZeroCount(),
